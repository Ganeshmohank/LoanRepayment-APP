...
public class CorsConfiguration {
  ...
  private static final String ALLOWED_ORIGIN = "*"; // Use specific origins for better security
  ...
  public WebFilter corsFilter() {
    return (ServerWebExchange ctx, WebFilterChain chain) -> {
      ...
      if (CorsUtils.isCorsRequest(request)) {
        ...
        headers.add("Access-Control-Allow-Credentials", "true"); // Allow cookies if needed
