...
public class SavingPaymentHistoryFilter extends GenericFilter{
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        if(req.getMethod().equalsIgnoreCase(HttpMethod.OPTIONS.name())) {
            ...
            try {
                ...
                Claims currentcustid = (Claims) currentTokenObj.getBody();
                
                //current logged in user
                req.setAttribute("currentuser", currentcustid.getSubject());
